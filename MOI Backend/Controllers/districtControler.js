...
const createDistric = async (req, res) => {
    try {
        ...
        if (Name) {
            ...
            return res.status(200).json({ message: "Create succesfully ", distric: distric })
        }
    } catch (error) {
        return res.status(500).send(error.message)
    }
...
const updateDistric = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json({ message: "Update succesfully distric ", distric: distric })
    } catch (error) {
        return res.status(500).send(error.message)
    }
...
const deleteDistric = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json({ message: "delete succesfully distric ", distric: distric })
    } catch (error) {
        return res.status(500).send(error.message)
    }
...
module.exports = {
    getDistric, createDistric, updateDistric, deleteDistric
}