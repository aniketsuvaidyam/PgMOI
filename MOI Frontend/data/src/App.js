    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route path='/beneficiry' element={<Protected Component={Beneficiry} />} />
          <Route path='/state/list' element={<Protected Component={Statelist} />} />
          <Route path='/district/list' element={<Protected Component={Districtlist} />} />
          <Route path='/block/list' element={<Protected Component={Blocklist} />} />
          <Route path='/village/list' element={<Protected Component={Villagelist} />} />
          <Route path='/beneficirydata' element={<Protected Component={Benficiirydata} />} />
