                ...
                <div className="items-center ">
                    <div className="mt-5 md:mt-0 md:col-span-2">
                        ...
                        <div className="shadow overflow-hidden sm:rounded-md">
                            <div className="px-4  py-5 bg-gray-100 shadow sm:p-2 w-[700px]">
                                <div className="py-2 ml-24 w-[500px]">
                                    <div className="col-span-6 sm:col-span-3 lg:col-span-2 py-2">
                                        <label htmlFor="name" className="block text-sm font-medium text-gray-700">Name</label>
                                        <input type="text" name="name" id="name" placeholder=" Name" className="mt-1 focus:ring-indigo-500 pl-2 focus:border-indigo-500 bg-white block w-full shadow-sm h-8 sm:text-sm border-gray-300 rounded-md" onChange={(e) => { setname(e.target.value) }} />
                                    </div>
                                    <div className="col-span-6 sm:col-span-3 lg:col-span-2 py-2">
